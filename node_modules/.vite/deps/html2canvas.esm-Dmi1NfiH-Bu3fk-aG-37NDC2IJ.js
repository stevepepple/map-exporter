...
// node_modules/@watergis/mapbox-gl-export/dist/html2canvas.esm-Dmi1NfiH-Bu3fk-aG.js
var mt = function(e, A) {
...
var an = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (Ce = 0; Ce < Br.length; Ce++)
...
var Qn = function(e) {
  ...
  for (t = 0; t < r; t += 4)
    n = zA[e.charCodeAt(t)], s = zA[e.charCodeAt(t + 1)], o = zA[e.charCodeAt(t + 2)], i = zA[e.charCodeAt(t + 3)], Q[B++] = n << 2 | s >> 4, Q[B++] = (s & 15) << 4 | o >> 2, Q[B++] = (o & 3) << 6 | i & 63;
  return a;
};
var cn = function(e) {
...
var yn = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
...
var Vn = function(e, A) {
  ...
  return e.forEach(function(n, s) {
    var o = Ot.get(n);
    if (o > ir ? (B.push(true), o -= ir) : B.push(false), ["normal", "auto", "loose"].indexOf(A) !== -1 && [8208, 8211, 12316, 12448].indexOf(n) !== -1)
...
var kn = function(e, A, r, t, B) {
  ...
  if (lr(n, A) === oB)
    return pe;
  if (Ot.get(e[n]) === vt || (i === de || i === fe) && Ot.get(e[o]) === vt || i === ar || Q === ar || i === Qr || [FA, bt, $A].indexOf(i) === -1 && Q === Qr || [he, ZA, Dn, MA, SA].indexOf(Q) !== -1 || lr(n, A) === _A || gt(Qt, _A, n, A) || gt([he, ZA], xt, n, A) || gt(cr, cr, n, A))
    return P;
  if (i === FA)
    return pe;
  if (i === Qt || Q === Qt)
  ...
  if ([ee, Ae].indexOf(Q) !== -1)
    for (var c = [he, ZA].indexOf(i) !== -1 ? s : n; c >= 0; ) {
      var g = A[c];
      if (g === j)
        return P;
      if ([SA, MA].indexOf(g) !== -1)
  ...
  if (Gt === i && [Gt, Oe, Mt, St].indexOf(Q) !== -1 || [Oe, Mt].indexOf(i) !== -1 && [Oe, Ve].indexOf(Q) !== -1 || [Ve, St].indexOf(i) !== -1 && Q === Ve || ur.indexOf(i) !== -1 && [gr, Ae].indexOf(Q) !== -1 || ur.indexOf(Q) !== -1 && i === ee || aA.indexOf(i) !== -1 && aA.indexOf(Q) !== -1 || i === MA && aA.indexOf(Q) !== -1 || aA.concat(j).indexOf(i) !== -1 && Q === _A && Tn.indexOf(e[o]) === -1 || aA.concat(j).indexOf(Q) !== -1 && i === ZA)
    return P;
  if (i === ct && Q === ct) {
...
var UA = function(e, A) {
  return e !== ne ? false : A !== Ne;
};
var me = function(e, A, r) {
  return e === _ ? Pe(A) || UA(A, r) : Pe(e) ? true : !!(e === ne && UA(e, A));
};
var ut = function(e, A, r) {
  return e === LA || e === _ ? J(A) ? true : A === ce && J(r) : J(e === ce ? A : e);
};
var Ls = function(e) {
  var A = 0, r = 1;
...
var UB = (
  ...
  (function() {
    ...
    return e.prototype.write = function(A) {
      ...
      for (var t = false; r === ye && A.length < 6; )
        A.push(r), r = this.consumeCodePoint(), t = true;
      if (t) {
      ...
      if (me(B, n, s)) {
        ...
        return { type: 15, number: r, flags: t, unit: o };
      }
  ...
  switch (e.size) {
    ...
    case 2:
      if (e.shape === 0)
        ...
        var o = Math.min(Math.abs(r), Math.abs(r - B)) / Math.min(Math.abs(A), Math.abs(A - t)), i = Ir(t, B, A, r, true), a = i[0], Q = i[1];
    ...
    case 3:
      if (e.shape === 0)
        ...
        var o = Math.max(Math.abs(r), Math.abs(r - B)) / Math.max(Math.abs(A), Math.abs(A - t)), c = Ir(t, B, A, r, false), a = c[0], Q = c[1];
        n = eA(a - A, (Q - r) / o), s = o * n;
      }
      break;
  }
...
var Bo = function(e, A) {
  ...
  return nA(A).forEach(function(i, a) {
    ...
    stops: t,
    type: B
  } : { size: s, shape: n, stops: t, position: o, type: B };
};
var KB = "closest-side";
var mB = "farthest-side";
var LB = "closest-corner";
var vB = "farthest-corner";
var bB = "circle";
var DB = "ellipse";
var xB = "cover";
var MB = "contain";
    ...
    if (o === 0) {
      ...
      i = s.reduce(function(c, g) {
        if (a)
          ...
          return Array.isArray(t) || (t = []), t.push(g), false;
        return c;
      }, i);
    }
    if (i) {
  ...
  return nA(A).forEach(function(s, o) {
    ...
    if (o === 0 ? i = s.reduce(function(Q, c) {
      ...
      if (v(c))
        ...
        return Array.isArray(t) || (t = []), t.push(c), false;
      return Q;
    }, i)), i) {
      var a = et(e, s);
      B.push(a);
...
var fo = rt("top-left");
var po = rt("top-right");
var Ho = rt("bottom-right");
var Eo = rt("bottom-left");
var Bt = function(e) {
  return {
    name: "border-" + e + "-style",
    initialValue: "solid",
...
var Ei = {
  ...
  parse: function(e, A) {
    ...
    for (var n = 0; n < B.length; n += 2) {
      ...
      t.push({ open: s, close: o });
    }
    return t;
  }
};
var mr = function(e, A, r) {
  if (!e)
    return "";
  ...
  parse: function(e, A) {
    return A.length === 1 && Rt(A[0], "none") ? [] : nA(A).map(function(r) {
      for (var t = {
        ...
        var s = r[n];
        Rt(s, "inset") ? t.inset = true : HA(s) ? (B === 0 ? t.offsetX = s : B === 1 ? t.offsetY = s : B === 2 ? t.blur = s : t.spread = s, B++) : t.color = fA.parse(e, s);
      }
      return t;
    });
  }
...
var Mi = function(e) {
  ...
  var a = typeof ArrayBuffer < "u" && typeof Uint8Array < "u" && typeof Uint8Array.prototype.slice < "u" ? new ArrayBuffer(A) : new Array(A), Q = Array.isArray(a) ? a : new Uint8Array(a);
  for (t = 0; t < r; t += 4)
    n = re[e.charCodeAt(t)], s = re[e.charCodeAt(t + 1)], o = re[e.charCodeAt(t + 2)], i = re[e.charCodeAt(t + 3)], Q[B++] = n << 2 | s >> 4, Q[B++] = (s & 15) << 4 | o >> 2, Q[B++] = (o & 3) << 6 | i & 63;
  return a;
};
var Si = function(e) {
  for (var A = e.length, r = [], t = 0; t < A; t += 2)
...
var Ji = 1 << Gi;
var Yi = Ji - 1;
var br = function(e, A, r) {
  return e.slice ? e.slice(A, r) : new Uint16Array(Array.prototype.slice.call(e, A, r));
};
var Wi = function(e, A, r) {
  return e.slice ? e.slice(A, r) : new Uint32Array(Array.prototype.slice.call(e, A, r));
};
var Zi = function(e, A) {
...
var qi = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (xe = 0; xe < Dr.length; xe++)
...
var ca = function(e) {
  ...
  return t.fillStyle = "red", t.fillRect(0, 0, r, r), Nr(s).then(function(o) {
    ...
    return a.style.backgroundImage = "url(" + n + ")", a.style.height = r + "px", Rr(i) ? Nr(Xt(r, r, 0, 0, a)) : Promise.reject(false);
  }).then(function(o) {
...
var k = {
  ...
  get SUPPORT_FOREIGNOBJECT_DRAWING() {
    var e = typeof Array.from == "function" && typeof window.fetch == "function" ? ca(document) : Promise.resolve(false);
    ...
    if (r.textDecorationLine.length || o.trim().length > 0)
      if (k.SUPPORT_RANGE_BOUNDS) {
        ...
        if (i.length > 1) {
          ...
          n.push(new ie(o, gA.fromDOMRectList(e, i)));
      } else {
...
var wa = function(e, A) {
  ...
  if (r) {
    ...
    t.appendChild(A.cloneNode(true));
    var B = A.parentNode;
    if (B) {
      B.replaceChild(t, A);
      var n = ze(e, t);
...
var Ca = [32, 160, 4961, 65792, 65793, 4153, 4241];
var Ua = function(e, A) {
  for (var r = Pn(e, {
...
var Jt = (
  ...
  (function(e) {
    ...
    function A(r, t) {
      var B = e.call(this, r, t) || this;
      return B.start = t.start, B.reversed = typeof t.reversed == "boolean" && t.reversed === true, B;
    }
    return A;
  })(sA)
);
  ...
  for (var B = A.firstChild, n = void 0; B; B = n)
    if (n = B.nextSibling, WB(B) && B.data.trim().length > 0)
      ...
      if (jB(B) && B.assignedNodes)
        B.assignedNodes().forEach(function(o) {
          return ke(e, o, r, t);
        });
      else {
        var s = JB(e, B);
...
var Sa = (
  ...
  (function() {
    ...
    return e.prototype.getCounterValue = function(A) {
      ...
      var r = this, t = A.counterIncrement, B = A.counterReset, n = true;
      t !== null && t.forEach(function(o) {
        var i = r.counters[o.counter];
        i && o.increment !== 0 && (n = false, i.length || i.push(1), i[Math.max(0, i.length - 1)] += o.increment);
      });
      var s = [];
...
var mA = function(e, A, r) {
  r === void 0 && (r = ". ");
  var t = A.length;
  return zB(Math.abs(e), t, false, function(B) {
...
var ge = function(e, A, r) {
  ...
  switch (A) {
    ...
    case 8:
      return x(e, 945, 969, false, t);
    case 9:
      return x(e, 97, 122, false, t);
    case 10:
      return x(e, 65, 90, false, t);
    case 11:
      return x(e, 1632, 1641, true, t);
    case 12:
    case 49:
    ...
    case 13:
      return x(e, 2534, 2543, true, t);
    case 14:
    case 30:
      return x(e, 6112, 6121, true, t);
    case 15:
    ...
    case 18:
      return x(e, 2406, 2415, true, t);
    case 20:
      return GA(e, 1, 19999, Ga, 3, t);
    case 21:
      return x(e, 2790, 2799, true, t);
    case 22:
      return x(e, 2662, 2671, true, t);
    case 22:
    ...
    case 34:
      return x(e, 3792, 3801, true, t);
    case 37:
      return x(e, 6160, 6169, true, t);
    case 38:
      return x(e, 4160, 4169, true, t);
    case 39:
      return x(e, 2918, 2927, true, t);
    case 40:
      return x(e, 1776, 1785, true, t);
    case 43:
      return x(e, 3046, 3055, true, t);
    case 44:
      return x(e, 3174, 3183, true, t);
    case 45:
      return x(e, 3664, 3673, true, t);
    case 46:
      return x(e, 3872, 3881, true, t);
    case 3:
    default:
      return x(e, 48, 57, true, t);
  }
};
  ...
  (function() {
    ...
    return e.prototype.toIFrame = function(A, r) {
        ...
        if (s)
          if (!this.options.allowTaint && n)
            ...
            if (o) {
              ...
              i?.preserveDrawingBuffer === false && this.context.logger.warn("Unable to clone WebGL context as it has preserveDrawingBuffer=false", A);
            }
            s.drawImage(A, 0, 0);
          }
        return B;
      ...
      if (t && PA(A) && (Yt(A) || Re(A))) {
        ...
        Wr(A) && (r = true), Jr(A) || this.cloneChildNodes(A, B, r), a && B.insertBefore(a, B.firstChild);
            ...
            if (c.type === 0)
              ...
              if (c.name === "attr") {
                ...
                if (u && v(u)) {
                  ...
                  a.appendChild(o.createTextNode(ge(d, h, false)));
                }
              ...
              switch (c.value) {
                case "open-quote":
                  a.appendChild(o.createTextNode(mr(i.quotes, n.quoteDepth++, true)));
                  break;
                case "close-quote":
                  a.appendChild(o.createTextNode(mr(i.quotes, --n.quoteDepth, false)));
                  break;
                default:
                  a.appendChild(o.createTextNode(c.value));
              }
...
var Ya = ":before";
var Wa = ":after";
var Zt = "___html2canvas___pseudoelement_before";
var _t = "___html2canvas___pseudoelement_after";
var AB = `{
    content: "" !important;
    ...
    return e.prototype.addImage = function(A) {
      ...
      return X(this, void 0, void 0, function() {
        ...
        return N(this, function(o) {
          switch (o.label) {
            case 0:
              return r = An.isSameOrigin(A), t = !It(A) && this._options.useCORS === true && k.SUPPORT_CORS_IMAGES && !r, B = !It(A) && !r && !yt(A) && typeof this._options.proxy == "string" && k.SUPPORT_CORS_XHR && !t, !r && this._options.allowTaint === false && !It(A) && !yt(A) && !B && !t ? [
                2
                /*return*/
            ...
            case 2:
              return this.context.logger.debug("Added image " + A.substring(0, 256)), [4, new Promise(function(i, a) {
                ...
                Q.onload = function() {
                  return i(Q);
                }, Q.onerror = a, (eQ(n) || t) && (Q.crossOrigin = "anonymous"), Q.src = n, Q.complete === true && setTimeout(function() {
                  return i(Q);
          ...
          if (i.status === 200)
            if (o === "text")
              ...
              c.addEventListener("load", function() {
                return n(c.result);
              }, false), c.addEventListener("error", function(g) {
                return s(g);
              }, false), c.readAsDataURL(i.response);
            }
          else
...
var ja = /^data:image\/svg\+xml/i;
var za = /^data:image\/.*;base64,/i;
var $a = /^data:image\/.*/i;
var AQ = function(e) {
...
var qt = function(e, A, r, t) {
  e.container.elements.forEach(function(B) {
    ...
    if (n || s) {
      ...
      if (B.styles.isPositioned() || B.styles.opacity < 1 || B.styles.isTransformed()) {
        ...
        if (c < 0) {
          ...
          a.negativeZIndex.some(function(w, u) {
            return c > w.element.container.styles.zIndex.order ? (g = u, false) : g > 0;
          }), a.negativeZIndex.splice(g, 0, Q);
        } else if (c > 0) {
          var U = 0;
          a.positiveZIndex.some(function(w, u) {
            return c >= w.element.container.styles.zIndex.order ? (U = u + 1, false) : U > 0;
      ...
      B.styles.isInlineLevel() ? A.inlineLevel.push(o) : A.nonInlineLevel.push(o), qt(o, A, r, i);
    G(
      B.flags,
      8
      /* IS_LIST_OWNER */
...
var Bn = function(e, A) {
  for (var r = e instanceof Jt ? e.start : 1, t = e instanceof Jt ? e.reversed : false, B = 0; B < A.length; B++) {
    var n = A[B];
    n.container instanceof RB && typeof n.container.value == "number" && n.container.value !== 0 && (r = n.container.value), n.listValue = ge(r, n.container.styles.listStyleType, true), r += t ? -1 : 1;
  }
};
var QQ = function(e) {
...
var Te = function(e, A) {
  var r = [];
  return z(e) ? r.push(e.subdivide(0.5, false)) : r.push(e), z(A) ? r.push(A.subdivide(0.5, true)) : r.push(A), r;
};
var AA = function(e, A, r, t) {
  var B = [];
  return z(e) ? B.push(e.subdivide(0.5, false)) : B.push(e), z(r) ? B.push(r.subdivide(0.5, true)) : B.push(r), z(t) ? B.push(t.subdivide(0.5, true).reverse()) : B.push(t), z(A) ? B.push(A.subdivide(0.5, false).reverse()) : B.push(A), B;
};
var nn = function(e) {
...
var CQ = function(e, A, r) {
  var t = A[0], B = A[1], n = A[2], s = e[0], o = e[1];
  if (!s)
    return [0, 0];
  if (T(s) && o && T(o))
    return [b(s, r.width), b(o, r.height)];
  var i = Ge(n);
  ...
  var K = null, E = null;
  if (T(s) ? K = b(s, r.width) : o && T(o) && (E = b(o, r.height)), K !== null && (!o || VA(o)) && (E = Q && c ? K / t * B : r.height), E !== null && VA(s) && (K = Q && c ? E / B * t : r.width), K !== null && E !== null)
    return [K, E];
  ...
  switch (e) {
    ...
    case 3:
      return [
        ...
        new l(Math.round(t.left + n + o), Math.round(t.top)),
        new l(Math.round(t.left + n + o), Math.round(t.height + t.top)),
        new l(Math.round(t.left + n), Math.round(t.height + t.top))
      ];
    case 1:
      return [
        new l(Math.round(t.left + n), Math.round(t.top + s)),
        new l(Math.round(t.left + n + o), Math.round(t.top + s)),
        new l(Math.round(t.left + n + o), Math.round(t.top + s + i)),
...
var FQ = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";
var rB = "Hidden Text";
var hQ = (
  /** @class */
  (function() {
          ...
          switch (C.label) {
            ...
            case 14:
              if (t instanceof tr && (c = Math.min(t.bounds.width, t.bounds.height), t.type === Je ? t.checked && (this.ctx.save(), this.path([
                ...
                new l(t.bounds.left + c * 0.39363, t.bounds.top + c * 0.79)
              ]), this.ctx.fillStyle = O(Xr), this.ctx.fill(), this.ctx.restore()) : t.type === Ye && t.checked && (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(t.bounds.left + c / 2, t.bounds.top + c / 2, c / 4, 0, Math.PI * 2, true), this.ctx.fillStyle = O(Xr), this.ctx.fill(), this.ctx.restore())), pQ(t) && t.value.length) {
...
var pQ = function(e) {
  return e instanceof PB || e instanceof NB ? true : e instanceof tr && e.type !== Ye && e.type !== Je;
};
var HQ = function(e, A) {
  switch (e) {
    case 0:
      ...
      switch (iA.label) {
        case 0:
          ...
          return B = {
            ...
            proxy: A.proxy,
            useCORS: (S = A.useCORS) !== null && S !== void 0 ? S : false
          }, n = Lt({ logging: (Y = A.logging) !== null && Y !== void 0 ? Y : true, cache: A.cache }, B), s = {
          ...
          }, o = new gA(s.scrollX, s.scrollY, s.windowWidth, s.windowHeight), i = new vQ(n, o), a = (W = A.foreignObjectRendering) !== null && W !== void 0 ? W : false, Q = {
            allowTaint: (Z = A.allowTaint) !== null && Z !== void 0 ? Z : false,
            onclone: A.onclone,
...
//# sourceMappingURL=html2canvas.esm-Dmi1NfiH-Bu3fk-aG-37NDC2IJ.js.map
