...
function ht() {
  ...
  return o.sanitize = function(e) {
    ...
    if (he || Ne(n), o.removed = [], typeof e == "string" && (Y = !1), Y) {
      ...
      t = Ke("<!---->"), s = t.ownerDocument.importNode(e, !0), s.nodeType === V.element && s.nodeName === "BODY" || s.nodeName === "HTML" ? t = s : t.appendChild(s);
    else {
...
//# sourceMappingURL=purify.es-DHbHSKL1-BkvB_SMQ.js.map
